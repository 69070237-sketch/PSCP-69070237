...
```text
มีคน3คนโหวต เสร็จจะแสดงแค่คะแนนรวม และคนที่โหวตมากสุด ให้เช็คว่าคนโหวตมากสุดกับน้อยสุดห่างกันเกิน2มั้ย
```
...
```text
รับค่าfloat
ให้ตัวแปร เป้นค่าความห่างของคนเยอะกับคนน้อย
```
...
```text
ตามตรงเลยข้อนี้งงมาก ว่าต้องใช้อะไร ให้เพื่อนช่วยอธิบายเยอะมาก วิธีใช้epsilon แต่ก็พยายามทำความเข้าใจกับโจทย์
```

คุณยังทำอะไรด้วยตนเอง

```text
แค่รับค่า กับให้ตัวแปร
```
