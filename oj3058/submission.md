...
```text
สร้างสะพานตามความยาวที่กำหนด โดยที่ก้อนเล็กเท่ากับ1ก้อนใหญ่เท่ากับ5 ดูว่าจะสร้างสะพานได้ไหม โดนใช้ก้อนเล็กน้อยที่สุด
```
...
```text
รับinput a b goal
แทนค่าเป็นก้อนใหญ่ที่ต้องใช้ก้อนเล็กที่ต้องใช้ และนับว่าเช็คว่าจะสามารถสร้าง
```
