...
```text
ปราสาทแบ่งเป็นห้องสามเหลี่ยม เรียงเลขจากบนลงล่างหาจำนวนกำแพงน้อยที่สุดที่ต้องพังเพื่อเดินจากห้อง N ไปห้อง 1 ใช้BFS หาทางที่สั้นที่สุด
```
...
```text
รับค่า ใช้เครื่องมือทางคณิต วนลูป
```
...
```text
สอนการใช้ import math สอนแนวคิด และ while loop
```

คุณยังทำอะไรด้วยตนเอง

```text
ศึกษาและถาม แล้วมาลองทำเอง
```
