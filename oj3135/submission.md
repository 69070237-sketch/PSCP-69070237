...
```text
รับค่า3ตัว จำนวนคน ตำแหน่งที่หมุนต่อครั้ง และตำแหน่งของโจร และนับว่าหมุนกี่ครั้งก่อนจะไปถึงโจร
```
...
```text
รับค่า3ตัวในบรรทัดเดียว
วนลูปให้ถึงตำแหน่งที่รับค่าT
ใช้เงื่อนไขในการหา ว่าถึงtตอนไหน วนกี่ครั้ง
```
...
```text
ตอนแรกคิดว่าใช้forเพราะไม่เคยทำwhile ได้เพื่อนสอน
```
