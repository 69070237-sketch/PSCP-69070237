...
```text
คำนวณว่าบ้านที่พิกัดที่ให้ จะถูกน้ำหมึกท่วมในตอนไหน วินาทีที่เท่าไหร่
```
...
```text
รับค่าโดยใช้ split แทนค่า pi แทนค่าสมการ ใช้x2+y2หาค่า
```
...
```text
เขาทำให้รู้จัก ฟังก์ชั้นsplit และบรรทัดที่19-21
```

คุณยังทำอะไรด้วยตนเอง

```text
ที่เหลือทั้งการรับ วนลูป คำนวน ทำตามที่เพื่อนสอน
```
