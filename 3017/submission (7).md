...
```text
input เป็นราคาดั้งเดิมโดยยังไม่คิดค่าบริการกับvat
ใช้ if elif
output คือราคาที่คิดค่าบริการกับvatแล้ว
```
...
```text
รับ input เป็นค่าfloat
ให้ n = 0 
ใช้ if ราคาไม่ถึง 500 จะคิดค่าบริการ n = 50
ใช้ elif ราคามากกว่า10000 จะคิดค่าบริการ  n= 1000
ใช้ elif ราคาระหว่าง 501 - 9999 จะคิดค่าบริการ n = ราคา * 0.1
ให้ค่าใหม่ = เอา n ไป บวกกับ ราคา แล้วเอาไปคูณ 0.07
ใช้คำสั่ง print แล้วก้ให้ เป็นจุดทศนิยมสองตำแหน่ง
...
```text
อธิบายวิธีคิดและวิธีทำ
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำความเข้าใจและลองทำตามที่เพื่อนสอน
```
