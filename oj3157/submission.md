...
```text
รับค่าจำนวนค่าที่จะรับ เป็น+ - และดำเนินการตามเครื่องหมายที่ให้
```
...
รับค่า int
แทนค่าอะไรก็ได้ = 0
วนลูปตามค่าด้านบน ให้หยุดต่อเมื่อinputต่อไปที่จะรับครบตามค่าด้านบน
รับค่าอินพุตที่สอง
ใช้if ให้เงื่อนไขถ้า อินพุทที่รับเป็น+ ให้ตัวแทนค่า+10 เป็น-ให้-5 ได้ค่าเท่าไหร่ก็ปริ้นออกมา
```
