...
รับ input สองบรรทัด
สร้างตัวแปร mix
ใช้คำสั่ง if elif else ว่าถ้าสองสีนี้ผสมกันจะได้สีอะไร
ได้ค่าสีแล้วใช้คำสั่ง print
```
...
```text
ตอนแรกไม่รุ้ว่าใช้สีเดียวกันผสมกันได้เลยต้องเพิ่มคำสั่ง
```
