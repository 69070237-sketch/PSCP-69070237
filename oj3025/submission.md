...
```text
ให้เราเขียนโค้ดแสดงฤดูโดย เริ่มจากรับค่าตัวเลข แล้วให้เดือนไหนเป็นฤดูอะไร แล้วมาให้เงื่อนไขเช็ค วันอีกที
```
...
```text
รับค่าจำนวนเต็ม
ใช้if ให้เงื่อนไขที่เดือนไหนจะเป็นฤดูอะไร
ใช้if กับเดือนที่หาร3ลงอีกที
ปริ้น
```
...
```text
ตอนแรกจะเช็ครวดเดียว เขาเลยช่วยอธิบายให้เข้าใจมากขึ้น
```
