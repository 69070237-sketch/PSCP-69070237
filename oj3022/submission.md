...
```text
รับค่าจำนวนจริง ตัวอักษร มาก่อน แล้วแปลง หน่วยต้นทางให้เป็น องษาเซลเซียสก่อน แล้วแปลงไปเป็นค่าที่ต้องการอีกที
```
...
```text
รับค่าfloat stingที่ลบ•ออก
แปลงให้เป็นเซลเซียสโดยใช้if แล้วใช้สูตรที่ให้มา
```
...
```text
ตอนแรกที่เรารับค่าตัวอักษร ใส่เป็นstringเฉยๆ แต่เพื่อนบอกของเพื่อนใช้stripด้วยเผื่อเคสไหนใส่มาเป็น C•เลยทำตามดู และบางสูตรเรายังใส่วงเล็บผิด
```

คุณยังทำอะไรด้วยตนเอง

```text
ทำอย่างอื่นนอกเหนือจากที่ว่า
```
